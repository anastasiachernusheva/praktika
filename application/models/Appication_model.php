...
class Appication_model extends CI_Model{
    ...
    public function select_zayavki($id_zayavki){
        $sql = 'select users.fio, zayavki.id_zayavki, name, discription,photo_d,photo_p, status,date_start,date_end from users, zayavki where users.id_user=zayavki.id_user ORDER BY date_end DESC LIMIT 4';
